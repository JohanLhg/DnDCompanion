...
@DatabaseView(
    """
        SELECT
            character.id AS cid,
            proficiency.bonus AS proficiency,
        ...
        INNER JOIN proficiency_view proficiency ON character.id = proficiency.cid
    """,
...
data class StatsView(
    ...
    var cid: Long = 0,
    @ColumnInfo(name = STATS_PROFICIENCY)
    ...
    companion object {
        ...
        const val STATS_PROFICIENCY = "proficiency"
